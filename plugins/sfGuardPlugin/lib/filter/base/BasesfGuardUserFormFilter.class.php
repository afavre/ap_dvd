...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'serieproprietaire_list'        => new sfWidgetFormPropelChoice(array('model' => 'Serie', 'add_empty' => true)),
      'videoproprietaire_list'        => new sfWidgetFormPropelChoice(array('model' => 'Video', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'serieproprietaire_list'        => new sfValidatorPropelChoice(array('model' => 'Serie', 'required' => false)),
      'videoproprietaire_list'        => new sfValidatorPropelChoice(array('model' => 'Video', 'required' => false)),
    ));
  ...
  public function addSerieproprietaireListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(SerieproprietairePeer::UTILISATEUR_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(SerieproprietairePeer::SERIE_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(SerieproprietairePeer::SERIE_ID, $value));
    }
  ...
  public function addVideoproprietaireListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(VideoproprietairePeer::UTILISATEUR_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(VideoproprietairePeer::VIDEO_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(VideoproprietairePeer::VIDEO_ID, $value));
    }
