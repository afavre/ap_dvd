...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::NOM;
		}
	...
	public function setPrenom($v)
	{
		...
		if ($this->prenom !== $v) {
			$this->prenom = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::PRENOM;
		}
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::IMAGE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::NOM)) $criteria->add(sfGuardUserPeer::NOM, $this->nom);
		if ($this->isColumnModified(sfGuardUserPeer::PRENOM)) $criteria->add(sfGuardUserPeer::PRENOM, $this->prenom);
		if ($this->isColumnModified(sfGuardUserPeer::IMAGE)) $criteria->add(sfGuardUserPeer::IMAGE, $this->image);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Noteserieadmins from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collNoteserieadmins === null) {
			if ($this->isNew()) {
			   $this->collNoteserieadmins = array();
				...
				$criteria->add(NoteserieadminPeer::UTILISATEUR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getNoteserieadminsJoinSaison($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collNoteserieadmins === null) {
			if ($this->isNew()) {
				...
				$this->collNoteserieadmins = NoteserieadminPeer::doSelectJoinSaison($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Notevideoadmins from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collNotevideoadmins === null) {
			if ($this->isNew()) {
			   $this->collNotevideoadmins = array();
				...
				$criteria->add(NotevideoadminPeer::UTILISATEUR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getNotevideoadminsJoinVideo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collNotevideoadmins === null) {
			if ($this->isNew()) {
				...
				$this->collNotevideoadmins = NotevideoadminPeer::doSelectJoinVideo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Videoproprietaires from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collVideoproprietaires === null) {
			if ($this->isNew()) {
			   $this->collVideoproprietaires = array();
				...
				$criteria->add(VideoproprietairePeer::UTILISATEUR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getVideoproprietairesJoinVideo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVideoproprietaires === null) {
			if ($this->isNew()) {
				...
				$this->collVideoproprietaires = VideoproprietairePeer::doSelectJoinVideo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Serieproprietaires from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collSerieproprietaires === null) {
			if ($this->isNew()) {
			   $this->collSerieproprietaires = array();
				...
				$criteria->add(SerieproprietairePeer::UTILISATEUR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getSerieproprietairesJoinSerie($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collSerieproprietaires === null) {
			if ($this->isNew()) {
				...
				$this->collSerieproprietaires = SerieproprietairePeer::doSelectJoinSerie($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
