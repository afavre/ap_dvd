...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('Noteserieadmin', 'Noteserieadmin', RelationMap::ONE_TO_MANY, array('id' => 'utilisateur_id', ), null, null);
    $this->addRelation('Notevideoadmin', 'Notevideoadmin', RelationMap::ONE_TO_MANY, array('id' => 'utilisateur_id', ), null, null);
    $this->addRelation('Videoproprietaire', 'Videoproprietaire', RelationMap::ONE_TO_MANY, array('id' => 'utilisateur_id', ), 'CASCADE', null);
    $this->addRelation('Serieproprietaire', 'Serieproprietaire', RelationMap::ONE_TO_MANY, array('id' => 'utilisateur_id', ), 'CASCADE', null);
	} // buildRelations()
