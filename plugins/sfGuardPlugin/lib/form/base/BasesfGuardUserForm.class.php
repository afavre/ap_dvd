...
abstract class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'serieproprietaire_list'        => new sfWidgetFormPropelChoice(array('multiple' => true, 'model' => 'Serie')),
      'videoproprietaire_list'        => new sfWidgetFormPropelChoice(array('multiple' => true, 'model' => 'Video')),
    ));
    ...
    $this->setValidators(array(
      ...
      'serieproprietaire_list'        => new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'Serie', 'required' => false)),
      'videoproprietaire_list'        => new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'Video', 'required' => false)),
    ));
  ...
  public function saveSerieproprietaireList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(SerieproprietairePeer::UTILISATEUR_ID, $this->object->getPrimaryKey());
    ...
    if (is_array($values))
    {
      foreach ($values as $value)
      {
        ...
        $obj->setUtilisateurId($this->object->getPrimaryKey());
  ...
  public function saveVideoproprietaireList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(VideoproprietairePeer::UTILISATEUR_ID, $this->object->getPrimaryKey());
