...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    ...
    <div >
		<div id="text">
		Vous souhaitez attribuer la note de <span class="note<?php echo $note; ?>" ><?php echo $note.'/10'; ?></span> au film "<b><?php echo $film->getTitre(); ?></b>"
		</div>
		<div id="textCom">
		Merci de commenter votre note:
		</div>
		<form method="POST" action="<?php echo url_for('film/AjouterNoteFilmAdmin') ?>" >
