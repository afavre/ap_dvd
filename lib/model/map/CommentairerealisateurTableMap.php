...
/**
 * This class defines the structure of the 'commentairerealisateur' table.
 *
 *
 ...
 */
class CommentairerealisateurTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.CommentairerealisateurTableMap';
	...
	{
	  // attributes
		$this->setName('commentairerealisateur');
		$this->setPhpName('Commentairerealisateur');
		$this->setClassname('Commentairerealisateur');
...
} // CommentairerealisateurTableMap
