...
class SerieTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FORMAT_DUREE', 'FormatDuree', 'INTEGER', false, null, null);
    ...
    $this->addRelation('Saison', 'Saison', RelationMap::ONE_TO_MANY, array('id' => 'serie_id', ), null, null);
    $this->addRelation('Categorieserie', 'Categorieserie', RelationMap::ONE_TO_MANY, array('id' => 'serie_id', ), 'CASCADE', null);
    $this->addRelation('Serieproprietaire', 'Serieproprietaire', RelationMap::ONE_TO_MANY, array('id' => 'serie_id', ), 'CASCADE', null);
	} // buildRelations()
