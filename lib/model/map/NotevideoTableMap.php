...
/**
 * This class defines the structure of the 'notevideo' table.
 *
 *
 ...
 */
class NotevideoTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.NotevideoTableMap';
	...
	{
	  // attributes
		$this->setName('notevideo');
		$this->setPhpName('Notevideo');
		$this->setClassname('Notevideo');
